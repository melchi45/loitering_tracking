...
const SUITES = [
  ...
  { file: 'test/api/age_estimation.test.js',                srs: 'FR-AGE-001~034',                           label: 'AI Age Estimation (unit)', analysisOnly: true },
  { file: 'test/api/gender_classification.test.js',         srs: 'FR-GEN-001~034',                           label: 'AI Gender Classification (unit)', analysisOnly: true },
  ...
  { file: 'test/api/ingest_daemon_control.test.js',         srs: 'FR-IDC-001~013',                          label: 'Ingest Daemon Control (Start/Stop/Restart)', captureOnly: true },
