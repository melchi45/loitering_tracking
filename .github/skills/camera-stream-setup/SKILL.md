...
**설계 상세(필독) → [`docs/design/Design_UMP_Player_RTSP_over_WebSocket.md`](../../../docs/design/Design_UMP_Player_RTSP_over_WebSocket.md) (v2.9) · 운영 가이드 → [`docs/ops/UMP_Player_Streaming_Setup.md`](../../../docs/ops/UMP_Player_Streaming_Setup.md) (v1.6)**
