...
Fixed `w-72` right panel with 5 tabs: CAMERAS, ALERTS, ZONES, DETECTIONS, ANALYTICS. The Alerts tab shows a red badge with unacknowledged alert count (shows `9+` when ≥ 10). Active tab: `text-blue-400 border-b-2 border-blue-400`.
