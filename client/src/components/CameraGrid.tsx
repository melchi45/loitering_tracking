...
export default function CameraGrid({ layout, onCameraDoubleClick }: Props) {
        ...
        if (camera) {
          ...
          return (
            <div
              ...
              className={`relative bg-gray-900 rounded overflow-hidden aspect-video transition-all cursor-pointer ${
